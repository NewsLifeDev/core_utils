------------------utils
ESX = nil
print ('Script created by ! ^1Newslife')
...
function SetData()
	...
	Citizen.InvokeNative(GetHashKey("ADD_TEXT_ENTRY"), 'FE_THDR_GTAO', '~h~NewsLife')
end
...
Citizen.CreateThread(function()
    AddTextEntry("PM_PANE_LEAVE", "~r~Se déconnecter ~w~de~r~ TutorielYoutube")
end)
...
function id()
	...
	ESX.ShowNotification("Votre Id est le numéro: ~b~".. id2 .."") 
end
